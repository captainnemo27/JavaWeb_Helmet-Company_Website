 ...
 */
@WebServlet(
        urlPatterns = {"/deleteTask"}
)
public class deleteTasks_servlet extends HttpServlet {
    private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public deleteTasks_servlet() {
        super();
...
// check login
        ...
        int idTask = Integer.parseInt(idStr);
        ...
        try {
            UtilsDB.storedeleteTask(conn,idTask);
