 ...
 */
@WebServlet(
        name="checkSalaryYear",urlPatterns = {"/checkSalaryYear"}
)
public class checkSalaryYear_servlet extends HttpServlet {
    private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public checkSalaryYear_servlet() {
        super();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        int yearI = 2020/*java.time.LocalDate.now()*/;
        ...
        try {
            ...
            UtilsDB.storeCheckSalaryYear(conn,yearI);
            if (listSalary == null ) {
                hasError = true;
